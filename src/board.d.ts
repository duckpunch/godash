...
export declare class Board extends Record(
...
export declare function adjacentCoordinates(
  board: Board,
...
export declare function followupKo(
  board: Board,
  coordinate: Coordinate,
  color: Color
): Coordinate | null;

export declare function matchingAdjacentCoordinates(
  board: Board,
  coordinate: Coordinate,
  color: Color
): Set<Coordinate>;
...
export declare function liberties(
  board: Board,
  coordinate: Coordinate
): Set<Coordinate>;

export declare function libertyCount(
  board: Board,
  coordinate: Coordinate
): number;

export declare function isLegalMove(
  board: Board,
  coordinate: Coordinate,
  color: Color
): boolean;

export declare function isLegalBlackMove(
  board: Board,
  coordinate: Coordinate
): boolean;

export declare function isLegalWhiteMove(
  board: Board,
  coordinate: Coordinate
): boolean;

export declare function removeStone(
  board: Board,
  coordinate: Coordinate
): Board;

export declare function removeStones(
  board: Board,
  coordinates: Coordinate[]
): Board;

export declare function addMove(
  board: Board,
  coordinate: Coordinate,
  color: Color
): Board;

export declare function placeStone(
  board: Board,
  coordinate: Coordinate,
  color: Color,
  force?: boolean
...
export declare function placeStones(
  board: Board,
  coordinates: Coordinate[],
  color: Color,
  force?: boolean
...
export declare function constructBoard(
  coordinates: Coordinate[],
  board?: Board,
  startColor?: Color
): Board;
